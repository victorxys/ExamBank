...
97. 微信公众号增加一个”我的考勤“的功能，员工首次点击要求验证姓名与身份证号，核对成功后自动与当前用户的微信openid关联。这样下次点击”我的考勤“时，在公众号直接弹出相应的考勤填写界面，界面显示与员工关联的逻辑与现在一致。

98. 记录员工的过错与投诉，要简历一个标签库，同一个标签出现两次，就要有惩罚，目前记录在员工登记表中，需要逐渐想员工详情中迁移。

99. 合同详情页面，客户签约消息与员工签约消息的弹窗中，增加一个“查看合同”的连接，点击后可直接查看合同（在新标签中打开）
