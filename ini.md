...
60. 合同管理主要需求：
    ...
    2. 创建合同，选择合同类型（月嫂、育儿嫂、试工）
       2.1 由运营人员填写“乙方信息”，以及乙方劳务报酬（元/月）、保证金（元/月）、丙方管理费（元/月），勾选“是否自动续约”，填写“附件内容”、合同开始时间、合同结束日期。
       2.2 在填写“乙方信息”时，要让运营人员操作便捷，通过拼音方式，可以快速检索到系统中已有的员工信息，选择后自动带出乙方姓名、身份证号、身份证上地址、电话号码、劳务报酬、丙方管理费、保证金
       2.3 创建合同，状态是“未签署”，并生成一个签署链接，并生成一个消息通知模板
            ...
            2、 阅读完内容后，最下面签字、提交
            3、 看见提交成功即可
      2.4 客户点开上方链接,在手机端查看合同详情，并可以在线进行电子手写签名后点击，确认签署
      2.5 此时合同的”签署状态“为“客户已签署”，此时运营人员将此合同发送给员工，有员工进行“乙方人员签署”
      2.6 员工在线完成合同签署的过程与客户签署过程类似，最周点击“确认签署”，合同的”签署状态“改为“已签署”，合同正式生效，开始按现有逻辑生成账单。
      2.7 合同中有公司签章（区分萌姨萌嫂和家福安，分别对应月嫂和育儿嫂合同）
