...
67. 续签合同，财务调整项备注显示以及跳转链接没有显示

68. 跳转到续签合同详情时，要账单列表是空的，是否因为账单尚未生成？此处为了更好的体验，在创建续签账单的时候可以有一个 “正在创建账单..."的等待，账单创建完毕后再跳转到续签合同详情，这样就可以看到新的账单了！同时合同备注要保持和原合同一致。

69. 如果是”续签“的合同，在合同详情中显示一个”续签“，并且点击可以跳转到源合同，同样”源合同“详情中也要显示”已续签“，点击后可以跳转到已续签的合同详情中。
