...
58. 添加”试工合同“的时候同时要输出”月薪“并按”月薪“计算劳务费以及加班费，目前是按”日薪“计算的，会和实际有偏差。
...
7. 在账单列表，弹出的账单详情中完成“员工应缴款已支付”的时候，账单列表中的“代缴款”状态及金额没有即时更新。
8. 在财务调整项中，点击退款项，并设置为”已结算“，金额不会计入”实收总额“中，这样在删除这条退款的支付记录时就有问题了！！
