            ...
            cur.execute('''
                WITH correct_options AS (
                    SELECT 
                        ...
                        FILTER (WHERE o.is_correct) as correct_answer_chars
                    FROM option o
                ...
                SELECT 
                    ...
                    a.explanation,
                    co.correct_answer_chars,
                    array_agg(DISTINCT o.id) FILTER (WHERE o.is_correct) as correct_option_ids
                FROM question q
                LEFT JOIN answer a ON q.id = a.question_id
                LEFT JOIN option o ON q.id = o.question_id
                CROSS JOIN correct_options co
                WHERE q.id = %s
                GROUP BY q.id, q.question_type, q.question_text, a.explanation, co.correct_answer_chars
